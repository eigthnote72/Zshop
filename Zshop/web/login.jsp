<%-- 
    Document   : login
    Created on : Mar 13, 2022, 4:47:48 PM
    Author     : Eighth_Note
--%>
                            ...
                            <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                                ...
                                <form action="login" method="post" style="width: 23rem;">
                                    ...
                                    <div class="form-outline mb-4">
                                        <input type="text" id="form2Example18" class="form-control form-control-lg" placeholder="Username"  name="user" />
                                    ...
                                    <div style="margin-bottom: 10px;">
                                        <input type="checkbox" value="remeber" name="checkbox"/> Remember me
                                    </div>
                                    ...
                                    <p>Don't have an account? <a href="registerAccount.jsp" class="link-info">Register here</a></p>
